...
(function ($) {
     ...
     * --------------------------------------------------*/
    function custom_bg() {
        $("body,div,section,span,form,img").css(
            "background-color",
            function () {
    ...
    function sequence() {
        ...
        for (var i = 0; i <= count; i++) {
            var sqx = jQuery(
                ".sequence > .gallery-item:eq(" + i + ") .de-item"
            );
    ...
    function de_share() {
        ...
        $(".fa-envelope").on("click", function () {
            window.open(
                "mailto:?subject=Share With Friends&body=" + url,
                "_blank"
            );
        });
    }
    ...
    $(function () {
        ...
        jQuery("#menu-btn").on("click", function () {
            ...
            if (mobile_menu_show === 0) {
                ...
                jQuery("li.tracking-link-mobile").css("display", "block");
            } else {
                jQuery("header").removeClass("menu-open");
                jQuery("header").css("height", "auto");
                mobile_menu_show = 0;
                jQuery(this).removeClass("menu-open");
                jQuery("li.tracking-link-mobile").css("display", "none");
            }
        });
            ...
            if (
                Array.prototype.some.call(
                    ...
                    function (element) {
                        ...
                        var elementBottom =
                            $(element).outerHeight() + elementTop;
                        if (
